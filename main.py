...
while True:
    if select.select([sys.stdin], [], [], 0.05)[0]:
        ...
        try:
            ...
            color = C_CPU if cpu_pct < 70 else (C_ORANGE if cpu_pct < 90 else C_RED)
            ...
            color = C_RAM if ram_pct < 80 else (C_ORANGE if ram_pct < 95 else C_RED)
            ...
            color = C_DSK if dsk_pct < 80 else (C_ORANGE if dsk_pct < 95 else C_RED)
